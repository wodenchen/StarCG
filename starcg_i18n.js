...
(function (global) {
  ...
  const M = {
    ...
    'char.params': { 'zh-TW': '參數設定', en: 'Settings', ko: '설정' },
    ...
    'char.crystalEnable': { 'zh-TW': '計入水晶能力', en: 'Include crystal stats', ko: '크리스탈 스탯 포함' },
    ...
    'char.crystalNoRoll': { 'zh-TW': '未計入水晶能力', en: 'Crystal stats excluded', ko: '크리스탈 스탯 미포함' },
    ...
    'char.hyoriki': { 'zh-TW': '百靈耐（玩家製作／水龍系列 攻防敏回精 +5%）', en: 'Hyoriki (+5% ATK/DEF/AGI/REC/SPI on crafted / water-dragon)', ko: '백령내 (제작/수룡 시리즈 공/방/민/회/정 +5%)' },
